...
#ifndef UnitReadShiftDataH
#define UnitReadShiftDataH
//---------------------------------------------------------------------------
...
public:
	...
	AnsiString GetID_GIP() {return IdGIP; }
	...
	void Remove(int i) { } //It needs to be redefined otherwise it will be abstract class
	void Reset()
	{
	  Id=ShiftLetter=ShiftType= ShiftSupervisorGIP= ShiftSupervisor= ProcessOperator =  BoothOperator = NoOfOperators = 0;
