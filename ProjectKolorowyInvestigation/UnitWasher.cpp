...
static AnsiString Database = "Problems_Line3";
...
void DeleteWasher()
{
    Picker = FormMain->DateTimePickerWasher;
    Contact = FormMain->EditContactWasher ;//Contact person
 	MTComment = FormMain->EditMTCommentWasher;
 	Problem = FormMain->EditProblemWasher;
 	Combo = FormMain->ComboBoxWasher;
    Sheet = FormMain->StringGridWasher;
    try{
